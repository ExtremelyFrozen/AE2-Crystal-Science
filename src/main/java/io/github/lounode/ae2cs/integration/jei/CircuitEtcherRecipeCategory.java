...
public class CircuitEtcherRecipeCategory implements IRecipeCategory<RecipeHolder<CircuitEtcherRecipe>> {

    public static RecipeType<RecipeHolder<CircuitEtcherRecipe>> RECIPE_TYPE = RecipeType.createRecipeHolderType(AE2CrystalScience.makeId("circuit_etcher"));
    ...
    public CircuitEtcherRecipeCategory(IJeiHelpers jeiHelper) {
        var guiHelper = jeiHelper.getGuiHelper();
        this.background = guiHelper.createDrawable(AE2CrystalScience.makeId("textures/gui/recipe/circuit_etcher.png"), 0, 0, 135, 58);
    ...
    @Override
    public @NotNull RecipeType<RecipeHolder<CircuitEtcherRecipe>> getRecipeType() {
        return RECIPE_TYPE;
    }
    ...
    @Override
    public void draw(@NotNull RecipeHolder<CircuitEtcherRecipe> recipe, @NotNull IRecipeSlotsView recipeSlotsView,
    ...
    @Override
    public void getTooltip(@NotNull ITooltipBuilder tooltip, @NotNull RecipeHolder<CircuitEtcherRecipe> recipe,
    ...
    @Override
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, @NotNull RecipeHolder<CircuitEtcherRecipe> recipe, @NotNull IFocusGroup focuses) {
        int xIn = 30;
        int y0 = 3;
        int dy = 18;
