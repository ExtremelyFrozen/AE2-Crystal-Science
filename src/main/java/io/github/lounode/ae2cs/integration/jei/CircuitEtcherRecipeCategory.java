...
public class CircuitEtcherRecipeCategory implements IRecipeCategory<CircuitEtcherRecipe>
{
    public static RecipeType<CircuitEtcherRecipe> RECIPE_TYPE = RecipeType.create(AECSConstants.MODID, "circuit_etcher",
            CircuitEtcherRecipe.class);
    ...
    @Override
    public @NotNull RecipeType<CircuitEtcherRecipe> getRecipeType()
    {
        return RECIPE_TYPE;
    }
    ...
    @Override
    public void draw(@NotNull CircuitEtcherRecipe recipe, @NotNull IRecipeSlotsView recipeSlotsView,
    ...
    @Override
    public void getTooltip(@NotNull ITooltipBuilder tooltip, @NotNull CircuitEtcherRecipe recipe,
    ...
    @Override
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, @NotNull CircuitEtcherRecipe recipe, @NotNull IFocusGroup focuses)
    {
        int xIn = 30;
        int y0 = 3;
        int dy = 18;
