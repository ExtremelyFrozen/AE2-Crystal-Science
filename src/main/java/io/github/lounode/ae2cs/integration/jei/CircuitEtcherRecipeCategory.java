...
{
    public static IRecipeType<RecipeHolder<CircuitEtcherRecipe>> RECIPE_TYPE = IRecipeHolderType.create(AE2CrystalScience.makeId("circuit_etcher"));
    ...
    @Override
    public @NotNull IRecipeType<RecipeHolder<CircuitEtcherRecipe>> getRecipeType()
    {
        return RECIPE_TYPE;
    }
