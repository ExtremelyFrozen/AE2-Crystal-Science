...
public class AECSCompatEAERecipeProvider extends AECSRecipeProvider
{
    ...
    public AECSCompatEAERecipeProvider(HolderLookup.Provider registries, RecipeOutput output)
    {
    ...
    {
        var compatOut = this.output.withConditions(modLoaded(AECSConstants.EAE_ID));
        ...
        // 扩展接口联动配方
        CrystalAssemblerRecipeBuilder.assemble(AECSBlocks.EX_ENDER_INTERFACE_BLOCK, this.items, this.fluids)
        ...
        CrystalAssemblerRecipeBuilder.assemble(AECSBlocks.EX_RESONATING_PATTERN_PROVIDER_BLOCK, this.items, this.fluids)
        ...
        CrystalAssemblerRecipeBuilder.assemble(AECSBlocks.EX_INTEGRATED_INTERFACE_BLOCK, this.items, this.fluids)
    ...
    public static class Runner extends RecipeProvider.Runner
    {
        ...
        {
            return new AECSCompatEAERecipeProvider(provider, output);
        }
