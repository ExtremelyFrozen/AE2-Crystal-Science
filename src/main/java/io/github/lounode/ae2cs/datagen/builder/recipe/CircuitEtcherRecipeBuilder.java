...
public class CircuitEtcherRecipeBuilder implements RecipeBuilder
{
    ...
    private CircuitEtcherRecipeBuilder(ItemStack result, int time)
    {
        this.result = result;
        this.time = time;
    }

    public static CircuitEtcherRecipeBuilder etching(ItemStack result, int time)
    {
        return new CircuitEtcherRecipeBuilder(result, time);
    }

    public static CircuitEtcherRecipeBuilder etching(ItemLike result, int count, int time)
    {
        return new CircuitEtcherRecipeBuilder(new ItemStack(result, count), time);
    }
    ...
    public void save(RecipeOutput output, @NotNull ResourceLocation id)
    {
        ...
        var recipe = new CircuitEtcherRecipe(a, b, c, result, time);
