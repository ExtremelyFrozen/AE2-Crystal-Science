...
public enum AECSIcon implements IButtonIcon
{
    ...
    BUTTON_PURPLE_COMMON(0, 240),
    BUTTON_PURPLE_COMMON_HOVER(0, 224),
    BUTTON_PURPLE_BIG(64, 238, 18, 18),
    BUTTON_PURPLE_BIG_HOVER(136, 238, 18, 18),

    BUTTON_BLUE_COMMON(16, 240),
    BUTTON_BLUE_COMMON_HOVER(16, 224),
    BUTTON_BLUE_BIG(82, 238, 18, 18),
    BUTTON_BLUE_BIG_HOVER(154, 238, 18, 18),

    BUTTON_RED_COMMON(32, 240),
    BUTTON_RED_COMMON_HOVER(32, 224),
    BUTTON_RED_BIG(100, 238, 18, 18),
    BUTTON_RED_BIG_HOVER(172, 238, 18, 18),

    BUTTON_ORIGINAL_COMMON(48, 240),
    BUTTON_ORIGINAL_COMMON_HOVER(48, 224),
    BUTTON_ORIGINAL_BIG(118, 238, 18, 18),
    BUTTON_ORIGINAL_BIG_HOVER(190, 238, 18, 18),
