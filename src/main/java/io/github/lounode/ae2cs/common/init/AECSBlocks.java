...
public class AECSBlocks {
     ...
     * 赛特斯石英矿石
     */
    public static final RegistryBlock<CertusQuartzOreBlock> CERTUS_QUARTZ_ORE = registerOtherBlock(AECSBlockIds.CERTUS_QUARTZ_ORE,
     ...
     * 深层赛特斯石英矿石
     */
    public static final RegistryBlock<CertusQuartzOreBlock> DEEPSLATE_CERTUS_QUARTZ_ORE = registerOtherBlock(AECSBlockIds.DEEPSLATE_CERTUS_QUARTZ_ORE,
            () -> new CertusQuartzOreBlock(
     ...
     * 充能赛特斯石英矿石
     */
    public static final RegistryBlock<ChargedCertusQuartzOreBlock> CHARGED_CERTUS_QUARTZ_ORE = registerOtherBlock(AECSBlockIds.CHARGED_CERTUS_QUARTZ_ORE,
     ...
     * 深层充能赛特斯石英矿石
     */
    public static final RegistryBlock<ChargedCertusQuartzOreBlock> DEEPSLATE_CHARGED_CERTUS_QUARTZ_ORE = registerOtherBlock(AECSBlockIds.DEEPSLATE_CHARGED_CERTUS_QUARTZ_ORE,
