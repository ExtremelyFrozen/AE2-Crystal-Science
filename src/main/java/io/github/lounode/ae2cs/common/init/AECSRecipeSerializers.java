...
public class AECSRecipeSerializers {
    ...
    public static final DeferredRegister<RecipeSerializer<?>> RECIPE_SERIALIZERS = DeferredRegister.create(ForgeRegistries.RECIPE_SERIALIZERS, AECSConstants.MODID);

    public static final Supplier<RecipeSerializer<CircuitEtcherRecipe>> CIRCUIT_ETCHER = RECIPE_SERIALIZERS.register("circuit_etcher_recipe_serializer", CircuitEtcherRecipeSerializer::new);
