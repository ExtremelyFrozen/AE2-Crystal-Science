...
public final class AECSEnchantments {
    ...
    private static ResourceKey<Enchantment> define(
        ...
        String finalDescKey = (descriptionKey == null || descriptionKey.isBlank()) ? ("enchantment." + AECSConstants.MODID + "." + path) : descriptionKey;
    ...
    private static void register(BootstrapContext<Enchantment> ctx, HolderGetter<Item> items, Def def) {
        ...
        Optional<HolderSet<Item>> primaryItems = def.showInEnchantingTable() ? Optional.empty() : Optional.of(emptyPrimary());
