...
public class AECSRecipeTypes {
    ...
    public static final DeferredRegister<RecipeType<?>> RECIPE_TYPES = DeferredRegister.create(ForgeRegistries.RECIPE_TYPES, AECSConstants.MODID);

    public static final Supplier<RecipeType<CircuitEtcherRecipe>> CIRCUIT_ETCHER = RECIPE_TYPES.register("circuit_etcher_recipe",
            () -> RecipeType.simple(AE2CrystalScience.makeId("circuit_etcher_recipe")));

    public static final Supplier<RecipeType<CrystalAggregatorRecipe>> CRYSTAL_AGGREGATOR = RECIPE_TYPES.register("crystal_aggregator_recipe",
