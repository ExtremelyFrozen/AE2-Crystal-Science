...
public class SimplePatternProviderPartItem extends PartItem<SimplePatternProviderPart>
{
    public SimplePatternProviderPartItem(Properties properties)
    {
        super(properties, SimplePatternProviderPart.class, SimplePatternProviderPart::new);
    }
