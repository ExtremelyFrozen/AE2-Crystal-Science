        ...
        CustomReturnableSubMenuHost
{
     ...
     * 升级仓
     */
    private final IUpgradeInventory upgrades = UpgradeInventories.forMachine(AECSBlocks.CIRCUIT_ETCHER_BLOCK.get(),
            4, this::saveChanges);
     ...
     */
    @Nullable
    private CircuitEtcherRecipe activeRecipe;
    ...
    public void serverTick()
    {
        ...
        CircuitEtcherRecipe recipe = activeRecipe;
    ...
    public void onLoad()
    {
        ...
        if (activeRecipeId != null && level != null)
        {
            ...
            opt.ifPresent(recipeHolder -> activeRecipe = (CircuitEtcherRecipe) recipeHolder);
        }
        updateActiveRecipe();
    }
