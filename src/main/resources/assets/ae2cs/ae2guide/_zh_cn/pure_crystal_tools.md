...
这些工具在数值层面仍然属于原版工具体系的范围，但通过附加功能，具备更高的实用性。
...
主要特性在于可以绑定到 **<ItemLink id="ae2:wireless_access_point" />**。

当末影水晶工具完成挖掘或击杀行为时，产生的掉落物会被直接发送至绑定的 ME 网络库存中。

与无线终端不同，末影水晶工具在使用时不要求工具本身处于无线接入点的有效连接范围内。
只要绑定的无线接入点所在区块处于加载状态，这个功能即可正常生效。
