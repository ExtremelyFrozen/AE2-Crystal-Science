...
AECS 为高纯水晶引入了可以发电的属性，使水晶不仅作为材料参与合成，
...
**<ItemLink id="ae2cs:crystal_vibration_chamber" />** 是 AECS 的水晶发电设备，工作方式与
