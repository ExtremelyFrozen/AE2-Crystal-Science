...
加速卡可以提高供应器每轮能够接收的合成请求数量。

**<ItemLink id="ae2cs:overload_card" />** 可进一步强化设备：

- **安装 1 张：** 每 **4 游戏刻**工作一次，并使每轮合成请求容量增加 **128**。
- **安装 2 张：** 每 **1 游戏刻**工作一次，并使每轮合成请求容量增加 **256**。
- **安装 3 张：** 每 **1 游戏刻**工作一次，并使每轮合成请求容量增加 **384**。
- **安装 4 张：** 每 **1 游戏刻**工作一次，并使每轮合成请求容量增加 **512**。

方块和部件形态均最多安装四张陨石超频卡。安装任意数量的陨石超频卡后，加速卡不再提供额外加速。
